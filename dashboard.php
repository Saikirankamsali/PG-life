...
$sql_fav = "SELECT p.* FROM user_favorites uf INNER JOIN properties p ON uf.property_id = p.id WHERE uf.user_id = $user_id";
$result_fav = mysqli_query($conn, $sql_fav);
$user_favorites = $result_fav ? mysqli_fetch_all($result_fav, MYSQLI_ASSOC) : [];
?>
...
<body>
    ...
    ?>
        <div class="my-favorite-properties">
            <div class="page-container">
                <h1>My Favorites</h1>
                <?php
                foreach ($user_favorites as $property) {
                    $property_images = glob("img/properties/" . $property['id'] . "/*");
                ?>
                    <div class="property-card property-id-<?= $property['id'] ?> row">
                        <div class="image-container col-md-4">
